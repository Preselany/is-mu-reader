...
- Session cookies and the local API bearer token are secret. Files are stored with private POSIX permissions and excluded from the source distribution. Local storage is not encrypted.
